...
from utils.model_utils import soft_update, hard_update
from agents.model import GaussianPolicy, QNetwork, DeterministicPolicy
...
class SAC(object):
    ...
    def save_checkpoint(self, env_name, suffix="", ckpt_path=None):
        ...
        if ckpt_path is None:
            ckpt_path = "checkpoints/{}/sac_checkpoint_{}".format(env_name, suffix)
